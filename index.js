...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1065988274918797392/1236146515160858675/Lain.gif?ex=66384427&is=6636f2a7&hm=4d98d590ab029872aaafbdfebf9207ec7ebbfe732891f944ce7ffeb1640d0e88&']; //รูปใหญ่
